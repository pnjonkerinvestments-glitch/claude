...
• Country Mosaic: koppel naam, vlag, vorm en een verrassend feit
• Daily Clue Trail: raad het land met zo min mogelijk hints
...
• Country Mosaic: match name, flag, shape and a surprising fact
• Daily Clue Trail: guess the country with as few clues as possible
...
• Country Mosaic: une nombre, bandera, silueta y un dato sorprendente
• Daily Clue Trail: adivina el país con las menos pistas posibles
...
| Online-status (laatst gezien, huidige kamer) | Alleen bij accounts; alleen zichtbaar voor geaccepteerde vrienden | App-functionaliteit (vrienden, uitnodigingen) | Ja |
| Vriendenlijst en kameruitnodigingen | Alleen bij accounts | App-functionaliteit | Ja |
