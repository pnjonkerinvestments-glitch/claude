...
| DM Sans and Space Grotesk | `@fontsource/dm-sans` **5.2.8**, `@fontsource/space-grotesk` **5.2.10** | SIL Open Font License | Self-hosted WOFF2 files; font licence notices included. No runtime font tracking requests. |
