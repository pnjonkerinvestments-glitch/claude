...
function view(s: RankState, version = 0): RankView {
  ...
  return {...rest,...(s.competition?{score:dailyScore(s)}:{}),version,total:questions.length,learning:true,question:question as RankView['question'],...(s.phase==='finished'?{review:questions}:{})};
}
