...
export const HOW_TO_EXAMPLES: Record<string, L> = {
  ...
  daily: l('Stop 1 shows a red flag with a white cross: Switzerland. Stop 2 asks for the capital of Australia: Canberra, not Sydney.',
    'Stop 1 toont een rode vlag met een wit kruis: Zwitserland. Stop 2 vraagt de hoofdstad van Australië: Canberra, niet Sydney.',
    'La parada 1 muestra una bandera roja con una cruz blanca: Suiza. La parada 2 pide la capital de Australia: Canberra, no Sídney.'),
