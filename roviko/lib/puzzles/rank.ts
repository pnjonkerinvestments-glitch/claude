...
export type RankView = Omit<RankState, 'questions' | 'startedAt' | 'turnAt'> & { total: number; version: number; score?: number; question: RankRound | null; review?: RankRound[]; learning: true };
