...
const { HOW_TO_PLAY, HOW_TO_PLAY_ORDER, HOW_TO_PLAY_GROUPS, HOW_TO_PLAY_TITLE, messages, MODES, DAILY_MODES, HowToSteps, HowToPlayPage, howToTitle } = await import('../.test-runtime/how-to-play.mjs');
